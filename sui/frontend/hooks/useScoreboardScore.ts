...
async function fetchScoresTableId(client: SuiClient, scoreboardId: string): Promise<string> {
...
async function readScoreInfo(client: SuiClient, tableId: string, owner: string) {
