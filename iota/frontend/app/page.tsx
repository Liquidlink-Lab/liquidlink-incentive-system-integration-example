  ...
  return (
    <main className="container">
      <header>
        ...
        <p>
          The UI is built with Next.js, IOTA dapp kit, and the IOTA SDK. Once connected, you can read live
          scores and trigger the `periphery` entry functions against the configured CapStore and Scoreboard
          objects.
        </p>
      </header>
      <WalletControls />
